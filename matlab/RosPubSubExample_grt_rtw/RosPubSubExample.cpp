...
void RosPubSubExampleModelClass::step()
{
    ...
    RosPubSubExample_B.DataWrote[0] =
        std::sin(RosPubSubExample_P.Sine_Freq * DataWrote_tmp + RosPubSubExample_P.Sine_Phase)
            * RosPubSubExample_P.Sine_Amp
        + RosPubSubExample_P.Sine_Bias;
    RosPubSubExample_B.DataWrote[1] =
        std::sin(RosPubSubExample_P.Cosine_Freq * DataWrote_tmp + RosPubSubExample_P.Cosine_Phase)
            * RosPubSubExample_P.Cosine_Amp
        + RosPubSubExample_P.Cosine_Bias;
    ...
    (&RosPubSubExample_M)->Timing.t[0] =
        (&RosPubSubExample_M)->Timing.clockTick0 * (&RosPubSubExample_M)->Timing.stepSize0
        + (&RosPubSubExample_M)->Timing.clockTickH0 * (&RosPubSubExample_M)->Timing.stepSize0
              * 4294967296.0;
...
void RosPubSubExampleModelClass::initialize()
{
    ...
    (void) memset((void*) (&RosPubSubExample_M), 0, sizeof(RT_MODEL_RosPubSubExample_T));

    {
        /* Setup solver object */
        rtsiSetSimTimeStepPtr(&(&RosPubSubExample_M)->solverInfo,
                              &(&RosPubSubExample_M)->Timing.simTimeStep);
        rtsiSetTPtr(&(&RosPubSubExample_M)->solverInfo, &rtmGetTPtr((&RosPubSubExample_M)));
        rtsiSetStepSizePtr(&(&RosPubSubExample_M)->solverInfo,
                           &(&RosPubSubExample_M)->Timing.stepSize0);
    ...
    /* block I/O */
    (void) memset(((void*) &RosPubSubExample_B), 0, sizeof(B_RosPubSubExample_T));

    /* states (dwork) */
    (void) memset((void*) &RosPubSubExample_DW, 0, sizeof(DW_RosPubSubExample_T));
    ...
    /* Start for S-Function (BlockFactory): '<Root>/RosTopicPublisher' */
    {
        ...
        RosPubSubExample_DW.RosTopicPublisher_PWORK.blockPWork[1] = static_cast<void*>(blockInfo);
        ...
        params.storeParameter<double>(
            ...
            blockfactory::core::ParameterMetadata(
                blockfactory::core::ParameterType::DOUBLE, 3.0, 1.0, 1.0, "MessageQueue"));
        params.storeParameter<std::string>(
            "/PubSubExample",
            blockfactory::core::ParameterMetadata(
                blockfactory::core::ParameterType::STRING, 2.0, 1.0, 1.0, "TopicName"));
        params.storeParameter<std::string>(
            "RosToolbox",
            blockfactory::core::ParameterMetadata(
        ...
        // Inputs
        blockInfo->setInputPort({0, {1, 2}, blockfactory::core::Port::DataType::DOUBLE}

                                ,
                                static_cast<void*>(&RosPubSubExample_B.DataWrote[0]));
        ...
        RosPubSubExample_DW.RosTopicPublisher_PWORK.blockPWork[0] = static_cast<void*>(blockPtr);
    }
    // End of S-Function Block: <Root>/RosTopicPublisher
    /* Start for S-Function (BlockFactory): '<Root>/RosTopicSubscriber' */
    {
        ...
        blockfactory::coder::CoderBlockInformation* blockInfo =
            new blockfactory::coder::CoderBlockInformation();
        RosPubSubExample_DW.RosTopicSubscriber_PWORK.blockPWork[1] = static_cast<void*>(blockInfo);
        ...
        params.storeParameter<double>(
            2.0,
            blockfactory::core::ParameterMetadata(
                blockfactory::core::ParameterType::DOUBLE, 3.0, 1.0, 1.0, "MsgSize"));
        params.storeParameter<std::string>(
            "/PubSubExample",
            blockfactory::core::ParameterMetadata(
                blockfactory::core::ParameterType::STRING, 2.0, 1.0, 1.0, "TopicName"));
        ...
        // Outputs
        blockInfo->setOutputPort({0, {1, 2}, blockfactory::core::Port::DataType::DOUBLE}

                                 ,
                                 static_cast<void*>(&RosPubSubExample_B.DataRead[0]));
        ...
        // Store the block in the PWork vector
        RosPubSubExample_DW.RosTopicSubscriber_PWORK.blockPWork[0] = static_cast<void*>(blockPtr);
    }
    // End of S-Function Block: <Root>/RosTopicSubscriber
}
...
RosPubSubExampleModelClass::RosPubSubExampleModelClass()
{
    static const P_RosPubSubExample_T RosPubSubExample_P_temp = {
         ...
         * Referenced by: '<Root>/Cosine'
         */
        1.5707963267948966}; /* Modifiable parameters */
